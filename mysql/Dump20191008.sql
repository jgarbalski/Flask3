...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-08-05 11:47:47',NULL),('diagnostics.include_raw','OFF','2019-08-05 11:47:47',NULL),('ps_thread_trx_info.max_length','65535','2019-08-05 11:47:47',NULL),('statement_performance_analyzer.limit','100','2019-08-05 11:47:47',NULL),('statement_performance_analyzer.view',NULL,'2019-08-05 11:47:47',NULL),('statement_truncate_len','64','2019-08-05 11:47:47',NULL);
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bucketlist` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `tbl_user` VALUES (1,'name','email@mail.com','pbkdf2:sha256:150000$ho1185D1$72608b20038e708931a42d0c930331ddbb08f39541b0aa5dd59d505b5020c98d'),(2,'admin','admin@admin.admin','pbkdf2:sha256:150000$2FgV1hIP$834554938e5137ea4304eaa7a847a05bd69968b13799a93114d7572b00767006'),(3,'name','email@mail.liam','pbkdf2:sha256:150000$4EB55zBB$e82a0a00db3ea2b1f5cf0285819887edd611c4a030b9ddcd196dd61905b21edf');
...
INSERT INTO `tbl_wish` VALUES (4,'AAA','DDDD',2,'2019-08-05 17:24:22'),(5,'wish','wish bish',2,'2019-08-06 12:37:14'),(6,'bish bish wish','another one in the wishlist',2,'2019-08-06 12:42:14'),(7,'noh ein','mal',2,'2019-08-06 12:46:20'),(8,'hehehhehe','heheszki',2,'2019-08-06 13:44:41'),(9,'aaa','vvv',2,'2019-08-06 14:09:18'),(10,'wish','post\r\n',2,'2019-08-13 15:56:20'),(11,'asdfasf','adfadfdasf',2,'2019-08-20 11:54:38'),(12,'when in rome','bop your dome\r\n\r\nxD',2,'2019-10-08 18:29:12');
...
BEGIN
    select * from tbl_wish where p_user_id = wish_user_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-10-11 21:43:15
